...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-10 01:31`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/de4e21f6-54eb-4b03-b7ff-dbf7fe5b86dd.git
$ cd de4e21f6-54eb-4b03-b7ff-dbf7fe5b86dd
```
